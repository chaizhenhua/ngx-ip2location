...
typedef struct {
    // currently, Ip2Location library only support one IP2Location instance per process.
...
static ngx_int_t
ngx_http_ip2location_get_str_value(ngx_http_request_t *r,
                                   ngx_http_variable_value_t *v, uintptr_t data);

static ngx_int_t
ngx_http_ip2location_get_float_value(ngx_http_request_t *r,
                                     ngx_http_variable_value_t *v, uintptr_t data);
...
static ngx_conf_post_t ngx_http_ip2location_post_enable =
{ngx_http_ip2location_enable};

static ngx_conf_post_t ngx_http_ip2location_post_access_type =
...
static ngx_http_module_t  ngx_http_ip2location_module_ctx = {
    ...
    ngx_http_ip2location_create_main_conf, /* create main configuration */
    ngx_http_ip2location_init_main_conf,   /* init main configuration */

    NULL,                                  /* create server configuration */
    NULL,                                  /* merge server configuration */

    ngx_http_ip2location_create_loc_conf,  /* create location configuration */
    ngx_http_ip2location_merge_loc_conf    /* merge location configuration */
};
